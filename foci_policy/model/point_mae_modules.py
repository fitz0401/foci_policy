'''
ref: https://github.com/UT-Austin-RPL/GROOT/blob/master/groot_imitation/groot_algo/point_mae_modules.py
'''
import torch
...
import numpy as np
import random
from foci_policy.utils.point_cloud_ops import (
...
def fps(data, number):
    '''
        ...
        number int
    '''
    fps_idx = farthest_point_indices(data, number)
    fps_data = gather_points(
...
class Group(nn.Module):  # FPS + KNN
    ...
    def forward(self, xyz):
        ...
        idx = knn_indices(xyz, center, self.group_size) # B G M
