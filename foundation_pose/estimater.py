...
class FoundationPose:
  def __init__(self, model_pts, model_normals, symmetry_tfs=None, mesh=None, scorer:ScorePredictor=None, refiner:PoseRefinePredictor=None, cfg=None, glctx=None, debug=0, debug_dir='./debug_fp/'):
    self.gt_pose = None
